/* Hand-written Typert host face for dsh-plugin-prompt-edit.
  ...
  invocations: [
    {
      ...
      result: {
        mode: "strict",
        typeSymbol: "dsh-plugin-prompt-edit#promptEdit/resolve:result",
    ...
    },
    {
      ...
      result: {
        mode: "strict",
        typeSymbol: "dsh-plugin-prompt-edit#promptEdit/detach:result",
